#!/usr/bin/env python3
"""
Module containing the DeepNeuralNetwork class for multiclass classification with different activation functions
"""
import numpy as np
...
class DeepNeuralNetwork:
    ...
    def __init__(self, nx, layers, activation='sig'):
        ...
        Args:
            ...
            activation (str): Type of activation function used in hidden layers ('sig' or 'tanh')

        Raises:
            TypeError: If nx is not an integer or layers is not a list of positive integers
            ValueError: If nx is not positive or activation is not 'sig' or 'tanh'
        """
        ...
        self.__activation = activation  # Type of activation function for hidden layers
    ...
    def activation(self):
        """
        Getter method for the activation function type

        Returns:
            str: The type of activation function used in hidden layers
        """
        ...
        for layer_num in range(1, self.__L + 1):
            ...
            if layer_num == self.__L:
                ...
                if self.__activation == 'sig':
                    ...
                    # Tanh activation function: A = tanh(Z)
                    A_current = np.tanh(Z)
    ...
    def gradient_descent(self, Y, cache, alpha=0.05):
        ...
        for layer_num in range(self.__L, 0, -1):
            ...
            if layer_num > 1:
                ...
                # The derivative depends on the activation function used
                if self.__activation == 'sig':
